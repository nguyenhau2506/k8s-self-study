...
export function generateStaticParams() {
  return courses.flatMap((c) =>
    courseLessons(c)
      ...
      .map((l) => ({course: c.slug, slug: l.slug})),
  );
}
...
export default async function PreviewLessonPage({
  ...
  if (!found) notFound();
  // Public preview only serves public lessons; members content is gated.
  if (found.lesson.access !== 'public') redirect(`/learn/${courseSlug}/${slug}`);
